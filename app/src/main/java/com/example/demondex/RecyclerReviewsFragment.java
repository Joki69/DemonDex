...
import com.example.demondex.databinding.FragmentRecyclerReviewsBinding;
import com.example.demondex.databinding.ViewholderReviewBinding;
...
public class RecyclerReviewsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.irANuevoReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_recyclerReviewsFragment_to_newReviewFragment);
            }
        });
    ...
    class ReviewsAdapter extends RecyclerView.Adapter<ReviewViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ReviewViewHolder holder, int position) {
            ...
            holder.binding.rating.setRating(review.rating);

            holder.binding.rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
                @Override
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    navController.navigate(R.id.action_recyclerReviewsFragment_to_showReviewFragment);
                }
            });
        }
